...
class Agent:
    ...
    async def _execute_tool(
        ...
        if self.permission_checker:
            ...
            if decision.effect == "ask":
                ...
                # Yield the permission request event — caller will handle it
    ...
    def _snapshot_for_recovery(
        ...
        Re-reading from disk is one extra open per ReadFile — cheaper than
        parsing line numbers back out of the tool output.
        """
